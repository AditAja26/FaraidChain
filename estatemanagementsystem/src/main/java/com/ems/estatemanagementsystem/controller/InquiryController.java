...
public class InquiryController {
    ...
    public InquiryController(InquiryService inquiryService, UserService userService,
            ExternalAgencyService externalAgencyService, StateService stateService, DistrictService districtService,
        ...
        try {
            ...
            for (i = 0; i < agencyIds.size(); i++) {
                ...
                String emailBody = "Dear " + agencyName + ",\n\n"
                        ...
                        + "I am writing to inquire about the existence of estates for " + inquiry.getInquiryFor()
                        + " of " + user.getName() + " (" + user.getIDNum() + ")\n\n"
        ...
        for (int i = 0; i < agencies.size(); i++) {
            ...
            if (status == null) {
                ...
                if ("Estate Available".equals(status)) {
                    hasAvailable = true;
                    serviceFee = serviceFee + (float) agencies.get(i).getServiceFee();
                }
            }
        }

        // Set the overall inquiry status based on the presence of null statuses first,
